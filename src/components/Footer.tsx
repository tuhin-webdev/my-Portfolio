      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-16 pb-8">
        ...
        <div className="grid md:grid-cols-3 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-bold text-base text-white">
                MD<span className="text-lime-400">HASAN</span>
              </span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="mailto:mdhasan@gmail.com" className="flex items-center gap-2 text-sm text-gray-400 hover:text-lime-400 transition-colors">
                <span>✉️</span> mdhasan@gmail.com
              </a>
              <a href="tel:+8801XXXXXXXXX" className="flex items-center gap-2 text-sm text-gray-400 hover:text-lime-400 transition-colors">
                <span>📱</span> +880 1XXXXXXXXX
              </a>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-xs text-center flex items-center gap-1.5">
            © {new Date().getFullYear()} MD HASAN. Made with
            <motion.span
