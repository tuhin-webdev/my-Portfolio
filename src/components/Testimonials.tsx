...
const testimonials = [
  {
    ...
    avatar: '👨‍💼',
    rating: 5,
    text: "TUHIN delivered an exceptional e-commerce platform that exceeded all our expectations. His attention to detail, clean code, and professional communication made the entire process seamless. Highly recommended!",
  ...
  },
  {
    ...
    avatar: '👩‍💻',
    rating: 5,
    text: "Working with TUHIN was an absolute pleasure. He built a beautiful dashboard that transformed how we visualize our data. Fast delivery, perfect quality, and outstanding support. Will definitely work with him again.",
  ...
  },
  {
    ...
    avatar: '👨‍🚀',
    rating: 5,
    text: "TUHIN created a complete business management system for us. The system is robust, scalable, and easy to use. He understood our requirements perfectly and delivered exactly what we needed. Five stars!",
  ...
  },
  {
    ...
    avatar: '👩‍🎨',
    rating: 5,
    text: "The blog platform TUHIN built for us is stunning! Perfect UI, fast performance, and an amazing admin panel. He's truly a talented developer who goes above and beyond for his clients.",
  ...
  },
  {
    ...
    avatar: '🧑‍💻',
    rating: 5,
    text: "I've worked with many developers but TUHIN stands out for his technical skills and professional approach. He delivered a full-stack application on time with clean, well-documented code. Exceptional talent!",
