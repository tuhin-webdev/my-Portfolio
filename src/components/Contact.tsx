...
const contactInfo = [
  {
    icon: Mail,
    label: 'Email',
    value: 'dmsahabuddin48@gmail.com',
  ...
  },
  {
    icon: Phone,
    label: 'Phone',
    value: '+880 1985839844',
    href: 'tel:+8801985839844',
  ...
  return (
    <section id="contact" className="py-28 bg-gradient-to-b from-gray-50/50 to-white relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] floating-orb orb-bg-lime-soft" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] floating-orb orb-bg-yellow-soft" />
      </div>
